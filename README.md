...
Create a `.env` file in the `backend/` folder and configure these variables:
...
Access the frontend at `http://localhost:5173` and backend at `http://localhost:8000`.
...
Add the `.env` variables to your hosting platform (e.g., Vercel, Render).
